...
function activateCodeSnippet(app, palette, restorer, editorServices) {
    ...
    const openCodeSnippetEditor = (args) => {
        ...
        const codeSnippetEditor = new CodeSnippetEditor(contentsService, editorServices, tracker, codeSnippetWidget, args);
    ...
    app.commands.addCommand(saveCommand, {
        ...
        execute: () => {
            ...
            CodeSnippetInputDialog(codeSnippetWidget, highlightedCode.split('\n'), -1);
        }
    });
